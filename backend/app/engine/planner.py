    ...
    if plan.private_holdings:
        notes.append({
            ...
            "source": "The holding grows at the user-assumed rate and never enters the "
                      ...
                      "selected. Divestiture is either a one-time liquidity event (sells "
                      "the entire holding at the owner's chosen age) or a phased sale (a "
                      "fixed percentage of the ORIGINAL value sold each year starting at a "
                      "chosen age, e.g. 10%/yr, with basis reduced pro-rata) — mutually "
                      "exclusive. Either way the gain over cost basis is a long-term "
