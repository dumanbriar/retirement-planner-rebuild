...
export function YearTable({
  ...
  const cols: Col[] = useMemo(
    () => [
      ...
      { label: "Contrib.", help: "New money contributed to accounts this year. Excludes reinvested amounts (net Social Security / RMD inflows, tax savings, and retirement surplus), which appear in the Surplus reinv. column.", ...money((y) => y.accounts.reduce((s, a) => s + a.contribution, 0) - y.surplus_reinvested) },
      ...
      { label: "Healthcare", help: "Net healthcare cost: ACA premiums minus subsidies before 65; Medicare Part B (incl. IRMAA) plus other premiums/OOP after 65; minus any tax-free medical HSA withdrawals (split out in the workbook's 'W/D HSA (medical)' column).", ...money((y) => y.healthcare_cost) },
      ...
      { label: "Wd HSA", help: "Non-medical HSA withdrawals used to fund spending (taxable, plus 20% penalty before 65). Tax-free medical HSA draws are netted inside the Healthcare column and split out in the workbook's 'W/D HSA (medical)' column.", ...money((y) => y.withdrawals_by_type.hsa ?? 0) },
      ...
      { label: "Surplus reinv.", help: "Income beyond the year's needs, reinvested into the taxable/cash account: net pre-retirement inflows and Traditional tax savings during accumulation; excess forced income (e.g. RMDs) in retirement.", ...money((y) => y.surplus_reinvested) },
